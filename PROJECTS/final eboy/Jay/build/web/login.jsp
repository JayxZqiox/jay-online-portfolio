...
<%
    if (request.getMethod().equalsIgnoreCase("post")) {
        ...
        if (username.equals(adminUsername) && password.equals(adminPassword)) {
            ...
            ResultSet rs = null;
            int userId = -1; // Initialize user ID to -1
            try {
                ...
                out.println("<script>alert('An error occurred while processing your request. Please try again later.');</script>");
            } finally {
  ...
  text-align: center;
    ...
    <body class="align">
        <div class="grid">
            ...
            <p class="text--center">Not a member? <a href="signup.jsp">Sign up now
                <svg class="icon">
